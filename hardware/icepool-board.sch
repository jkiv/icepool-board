...
Wire Wire Line
	2450 3550 2450 3700
$Comp
L jkiv-renesas:ISL83488 U9
U 1 1 5E37A4EF
P 12500 5750
F 0 "U9" H 12500 6215 50  0000 C CNN
F 1 "ISL83488" H 12500 6124 50  0000 C CNN
F 2 "Package_SO:SOIC-8_3.9x4.9mm_P1.27mm" H 12500 5750 50  0001 C CNN
...
U 1 1 5E37CCF1
P 15100 5700
F 0 "J7" H 15180 5692 50  0000 L CNN
F 1 "UART" H 15180 5601 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x04_P2.54mm_Vertical" H 15100 5700 50  0001 C CNN
...
U 1 1 5E37DB0E
P 13950 5700
F 0 "J6" H 14030 5692 50  0000 L CNN
F 1 "RS485" H 14030 5601 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x04_P2.54mm_Vertical" H 13950 5700 50  0001 C CNN
...
U 1 1 5E392B99
P 11500 5750
F 0 "C95" H 11408 5704 50  0000 R CNN
F 1 "0.1u" H 11408 5795 50  0000 R CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 11500 5750 50  0001 C CNN
...
TX
Wire Wire Line
	11950 5850 11800 5850
Wire Wire Line
	11950 5700 11800 5700
Wire Wire Line
	11950 5550 11500 5550
Wire Wire Line
...
U 1 1 5E3E43DE
P 11500 5450
F 0 "#PWR0108" H 11500 5300 50  0001 C CNN
F 1 "+3V3" H 11515 5623 50  0000 C CNN
...
U 1 1 5E3E501C
P 11500 6100
F 0 "#PWR0109" H 11500 5850 50  0001 C CNN
...
$EndComp
Wire Wire Line
	11500 6000 11500 5850
Wire Wire Line
	11950 6000 11500 6000
...
Wire Wire Line
	14900 5700 14750 5700
$Comp
L power:+3V3 #PWR0110
U 1 1 5E450CFD
P 14700 5600
F 0 "#PWR0110" H 14700 5450 50  0001 C CNN
F 1 "+3V3" H 14715 5773 50  0000 C CNN
...
U 1 1 5E45B5DB
P 14700 5900
F 0 "#PWR0111" H 14700 5650 50  0001 C CNN
F 1 "GND" V 14705 5772 50  0000 R CNN
